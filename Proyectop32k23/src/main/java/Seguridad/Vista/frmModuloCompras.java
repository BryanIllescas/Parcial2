...
import Seguridad.Controlador.clsModulo;
import Seguridad.Modelo.daoCompras;
...
public class frmModuloCompras extends javax.swing.JInternalFrame {
    ...
    List<clsCompras> listamodulos = dao.obtenerCompras();
...
public frmModuloCompras() {
    ...
    compra.setIdCompras(Integer.parseInt(txtbuscado.getText()));
    
    // Crear un objeto de la clase daoCompras y llamar al método deleteCompra() para eliminar el registro.
    daoCompras dao = new daoCompras();
    int registrosBorrados = dao.deleteCompra(compra);

    // Mostrar un mensaje que informe si se eliminó o no el registro.
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        // TODO add your handling code here:
        clsCompras modulo = new clsCompras();
    modulo.setIdCompras(Integer.parseInt(txtbuscado.getText()));        
    modulo = daoCompras.getComprasPorId(modulo);
    System.out.println("Modulo retornado:" + modulo);        
    txtNombre.setText(modulo.getNombreCompras());
    txtEstatus.setText(modulo.getEstatusCompras());
...
//        // TODO add your handling code here:
        ...
        modulo.setIdCompras(Integer.parseInt(txtbuscado.getText()));
        modulo.setNombreCompras(txtNombre.getText());
        modulo.setEstatusCompras(txtEstatus.getText());

        daoCompras dao = new daoCompras();
        dao.modificarCompras(modulo);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        File file = new File("src\\main\\java\\ayudas\\ProcesoMayor.chm");
    if (file.exists()) {
        try {
        ...
        JOptionPane.showMessageDialog(null, "No se encontró la ayuda",
                "Información del Sistema", JOptionPane.INFORMATION_MESSAGE);
    }
